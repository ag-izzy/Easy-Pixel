...
---# Anti Cheat Citizen #---
EZPXC.CitizenWait = 2500

---# Anti Player Protection #---
EZPXC.AntiCheat = true

---# Anti Spectate #---
EZPXC.AntiSpectate = true

---# Anti BlackListWeapon #---
EZPXC.AntiBlackListWeapon = false

---# Anti Nui Devtools #---
EZPXC.NuiDevtools = true

---# Anti God Mode #---
EZPXC.AntiGodmode = true

---# Anti Teleport #---
EZPXC.AntiNoclip = true

---# Anti Speed Hack #---
EZPXC.AntiSpeedHack = false
EZPXC.MaxSpeed = 10
...
---# Anti Thermal Vision #---
EZPXC.ThermalVision = true

---# Anti Night Vision #---
EZPXC.AntiNightVision = true

---# Anti SuperJump #---
EZPXC.AntiSuperJump = true
EZPXC.SuperJumpMaxLength = 30.0

---# Anti Cheat Engine #---
EZPXC.AntiCheatEngine = true

---# Anti Unload Player #---
EZPXC.AntiUnLoadPlayer = true

---# Anti Resource Starter #---
EZPXC.AntiResourceStarter = false

---# Anti Resource Stopper #---
EZPXC.AntiResourceStopper = true

---# Anti Invisble #---
EZPXC.AntiInvisble = true

---# Anti Noclip #---
EZPXC.AntiNoclip = true

---# Anti Fly Cars #---
EZPXC.AntiFlyCars = true

---# Anti Change Damage #---
EZPXC.AntiWeaponDamageChange = true
EZPXC.AntiWeaponsExplosive = true
EZPXC.WeaponDamages = {
